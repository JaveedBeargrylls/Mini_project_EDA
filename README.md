# 📊 EDA Project: District-wise Missing Persons in India (2021 Onwards)

## 🗂️ Dataset Overview
This project involves exploratory data analysis on a dataset detailing missing persons cases reported across various districts in India from the year 2021 onward. The data is disaggregated by state, district, gender, and age group.
...
### 👁️‍🗨️ Key Features:
- `year`: Year of reporting (from 2021 onwards)
